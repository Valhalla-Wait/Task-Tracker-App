...
const selectSelf = (state: RootStateType) => state.сompletedList;
...
export const CompletedListCurrentPageSelector = createSelector(
  selectSelf,
  (completedListState) => completedListState.data.pagination.page_current,
);
